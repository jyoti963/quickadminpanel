    ...
    <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('general_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/settings*")||request()->is("admin/galleries*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-gift">
                            </i>
                ...
                @can('master_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/countries*")||request()->is("admin/departments*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fab fa-mastodon">
                            </i>
                            ...
                            @can('department_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/departments*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.departments.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fab fa-deploydog">
                                        </i>
                ...
                @can('content_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/employees*")||request()->is("admin/blogs*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-check-square">
                            </i>
                        ...
                        <ul class="ml-4 subnav hidden">
                            @can('employee_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/employees*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.employees.index") }}">
                            ...
                            @can('blog_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/blogs*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.blogs.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fab fa-blogger">
                                        </i>
